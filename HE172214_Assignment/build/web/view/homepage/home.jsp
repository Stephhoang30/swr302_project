<%-- 
    Document   : home
    Created on : Oct 17, 2024, 9:13:59 PM
    Author     : stephhoang
--%>
                                ...
                                <div class="left-menu mb-30">
                                    <ul>
                                        <c:forEach items="${categories}" var="c">
                                            <li><a href="home?action=searchByCategory&categoryId=${c.getId()}">${c.getName()}<span>(15)</span></a></li>
                                        </c:forEach>
                                    </ul>
                                </div>                              
                                <div class="left-title mb-20">
                                            ...
                                            <div class="product-wrapper mb-40">
                                                <div class="product-img">
                                                    <a href="product-details?id=${p.getId()}">
                                                        <img src="${pageContext.request.contextPath}/img/product/${p.getImage()}" alt="book" class="primary" />
                                                    </a>
